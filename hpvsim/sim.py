    ...
    def step(self):
        ...
        for lkey, layer in people.contacts.items():
            ...
            for g in range(ng):
                ...
                for i_sex, (pship_inds, sources, targets) in enumerate(discordant_pairs):
                    betas = (1 - (1 - gen_betas[g] * trans[i_sex] * (1 - effective_condoms) * (1. - sus_imm[g,targets]) * rel_sus[targets]) ** acts[pship_inds]).astype(hpd.default_float)  # Probability of infection
