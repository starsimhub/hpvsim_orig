...
def test_epi():
    ...
    vary_pars   = ['beta',          'acts',             'debut',            'init_hpv_prev', ] # Parameters
    vary_vals   = [[0.0001, 0.99],    [1, 200],         [15,25],             [0.01,0.8]] # Values
    vary_rels   = ['pos',           'pos',              'neg',              'pos'] # Expected association with epi outcomes
    vary_what   = ['total_hpv_incidence',    'total_hpv_incidence', 'total_hpv_incidence',    'total_cancer_incidence'] # Epi outcomes to check
